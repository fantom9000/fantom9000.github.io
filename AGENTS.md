...
- `/projects/quiz/` — uses correct Figma-derived SayGames blocks, structurally approved. **Pending image re-export** (still on old PNGs).
- `/projects/mary-trufel/` — uses correct Figma-derived blocks, structurally approved. **Pending image re-export**.
...
- **Quiz / Mary Trufel / Peptid.ru** — pending image re-export. Same pipeline:

...
- Latest known commit (на момент этой записи): `bd2d09f CI: bump Node from 20 to 22 (required by pnpm 11)`. Реальный последний — `git log --oneline -5`.
...
- `<meta property="og:image" content="https://fantom9000.github.io/og-image.png">` — превью 1200×630 (**абсолютный URL!**)
- `<meta property="og:url" content="https://fantom9000.github.io/">` — каноничный URL
- `<meta property="og:type" content="website">`
- `<meta name="twitter:card" content="summary_large_image">`
- `<meta name="twitter:title" content="...">`, `twitter:description`, `twitter:image`
- `<link rel="canonical" href="https://fantom9000.github.io/">` — для SEO

Что нужно от Романа:
- **OG image** — 1200×630, превью-карточка для шеринга в Telegram/WhatsApp/Twitter/LinkedIn. Обычно: имя, профессия, на тёмном/светлом фоне. Можно сделать в Figma вручную или собрать в HTML/CSS под задачу.
...
Файл OG image кладётся в `public/og-image.png` (или WebP), на абсолютный URL `https://fantom9000.github.io/og-image.png` указывают через `og:image`.
